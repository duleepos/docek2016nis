...
class Home_Model extends Model {
    ...
    public function getItems($categoryId = 0, $offset = 0, $limit = 0, $search = '', $ranges = array()) {
        ...
        $sql = "SELECT  i.`item_id`, i.`title`, i.`details`, i.`info`, i.`music`, i.`drink`, i.`food`, i.`address`,i.`maps`, i.`description`, i.`image`, i.`price`, i.`active`, i.`create_date`, i.`number_of_items`, i.`fk_category_id`,
                c.`name` AS `category`
                FROM `items` i
